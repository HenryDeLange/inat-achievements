export const en = {
    ...
    achievementEarlyBirdDetails: 'Observe both a Bird and a Worm () species on {{goal}} before 8AM on {{goal}} different days.',
    ...
    achievementHomelyHermitDetails: 'Make {{goal}} observations over 7 days of any Hermit Crab, Tortoise, Turtle, Snail and Bag Worm species.',
    achievementSlugfestTitle: 'Slugfest',
    achievementSlugfestDetails: 'Make {{goal}} observations of Slugs',
    achievementEmployeeOfTheMonthTitle: 'Employee Of The Month',
    achievementEmployeeOfTheMonthDetails: 'Make {{goal}} observations of Ants in one month.',
    ...
    achievementForeverSpringDetails: 'Observe a Flowering Plant that is annotated as "flowering" on each week of the year (calculated as {{goal}} periods of 7 days each, starting from the January 1st).',
    ...
    achievementCatsAndDogsDetails: 'Obtain {{goal}} observations of Feline and Canine species, but not on the same day.',
...
export const af = {
    ...
    achievementEarlyBirdDetails: 'Kry beide \'n Voêl en Wurm () spesie observasie voor 8AM op {{goal}} verskillende dae.',
    ...
    achievementHomelyHermitDetails: 'Maak {{goal}} observasies oor 7 dae van enige Kluisenaarskrap, Skilpad, Slak of Sakwurm spesie.',
    achievementSlugfestTitle: 'Sagte Slakke',
    achievementSlugfestDetails: 'Maak {{goal}} observasies van Doplose Slakke',
    achievementEmployeeOfTheMonthTitle: 'Werker Van Die Maand',
    achievementEmployeeOfTheMonthDetails: 'Maak {{goal}} observasies van Miere in een maand.',
    ...
    achievementCatsAndDogsDetails: 'Kry {{goal}} observasies van Cat Familie en Hond Familie species, maar nie op dieselfde dag nie.',
