export const en = {
    ...
    progressPreparing: 'Preparing the next Wild Achievements from the next {{per_page}} observations...',
    ...
    achievementSocialButterflyDetails: 'Obtain {{goal}} observations with comments of Lepidoptera (Butterflies and Moths).',
...
export const af = {
    ...
    progressPreparing: 'Besig om die Wilde Prestasies voor te bery van die volgende {{per_page}} observasies...',
