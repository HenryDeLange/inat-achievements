export const en = {
    ...
    achievementDailyLifeDetails: 'On {{goal}} days make {{goal}} observations of {{goal}} different species.',
...
export const af = {
    ...
    achievementDailyLifeDetails: 'Op {{goal}} dae maak {{goal}} observasies van {{goal}} verskillende spesies.',
