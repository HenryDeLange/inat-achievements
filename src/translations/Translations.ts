export const en = {
    ...
    progressPreparing: 'Preparing to calculate the next {{per_page}} observations... (Additional data may have to be fetched from iNaturalist.)',
...
export const af = {
    ...
    progressPreparing: 'Voorberyding om die volgende {{per_page}} observasies te bereken...',
