export const en = {
    ...
    progressPreparing: 'Preparing to calculate the next {{per_page}} observations... (Additional data is being fetched from iNaturalist, this might take a while the first time.)',
...
export const af = {
    ...
    progressPreparing: 'Voorberyding om die volgende {{per_page}} observasies te bereken... (Additionele data word vanaf iNaturalist gelaai.)',
